...
ax1.set_ylabel('E(t)')
plt.tight_layout()
plt.savefig("phase_Carrier.png", dpi=300, bbox_inches="tight")
...
ax2.set_ylabel('E(t)')
plt.tight_layout()
plt.savefig("phase_signal.png", dpi=300, bbox_inches="tight")
...
ax3.set_ylabel('E(t)')
plt.tight_layout()
plt.savefig("phase_modulation.jpg", dpi=300, bbox_inches="tight")
